...
namespace Zeroit.Framework.LineSeparators
{
    ...
    #region E N U M S    
    /// <summary>
    /// Enum for retrieving the Line style for <c><see cref="ZeroitSimpleLine" /></c>;
    /// </summary>
    ...
    /// <summary>
    /// Enum for setting the line gradient direction of  <c><see cref="ZeroitSimpleLine" /></c>;
    /// </summary>
    ...
    public class ZeroitSimpleLine : System.Windows.Forms.UserControl
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZeroitSimpleLine"/> class.
        /// </summary>
        public ZeroitSimpleLine()
        {
    ...
    public class ZeroitSimpleLineSmartTagActionList : System.ComponentModel.Design.DesignerActionList
    {
        ...
        /// </summary>
        private ZeroitSimpleLine colUserControl;
        ...
        {
            this.colUserControl = component as ZeroitSimpleLine;
