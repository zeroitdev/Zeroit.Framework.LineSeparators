...
// ***********************************************************************
// <copyright file="Zeroit_Lines.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.LineSeparators
{
    ...
    /// Class MSColorTable.
    /// </summary>
    /// <seealso cref="Zeroit.Framework.LineSeparators.ColorTable" />
    ...
    /// </summary>
    /// <seealso cref="Zeroit.Framework.LineSeparators.xColorTable" />
    ...
    /// <summary>
    /// Enum for setting the mouse state. Not to be used any programming activity
    /// as it is just a helper.
    /// </summary>
